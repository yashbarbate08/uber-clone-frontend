...
//                 {/* {caption?.fullname?.firstname || "John"}{" "} */}
//                 Yash
//               </h2>
//               <h4 className="text-xs text-zinc-500">MH40CL0274</h4>
//             </div>
//             <div className="flex flex-col justify-end">
//               <h2 className="text-[15px] font-semibold">₹654.80</h2>
...
//             <h3 className="font-semibold">50 km</h3>
